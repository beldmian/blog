...
(def cv-download-page
  [:div
   [:h1 "Curriculum Vitae"]
   [:p "Download my CV to learn more about my professional experience, skills, and education."]

   ;; CV download card
   [:div {:style {:margin (str (responsive/spacing :lg) " 0")
    ...
    [:h2 {:style {:margin-bottom (responsive/spacing :md)}}
     "Download My CV"]
    ...
    ;; Download button
    [:div {:style {:margin-top (responsive/spacing :lg)}}
     (Button "Download CV (Russian)" "/public/assets/cv.pdf")]

    ;; Additional information
    [:p {:style {:margin-top (responsive/spacing :md)
                 :font-size "0.9rem"
