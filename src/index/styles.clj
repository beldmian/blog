...
(def typography
  [;; Headings
   [:h1 {:font-size (get-in responsive/responsive-font-sizes [:h1 :xs])
         :font-weight "700"
   ...
   [:h2 {:font-size (get-in responsive/responsive-font-sizes [:h2 :xs])
         :font-weight "700"
   ...
   [:h3 {:font-size (get-in responsive/responsive-font-sizes [:h3 :xs])
         :font-weight "600"
         :margin (str (responsive/spacing :md) " 0 " (responsive/spacing :sm) " 0")
         :color colors/primary
         :line-height "1.4"}]
   ...
   [:h4 {:font-size (get-in responsive/responsive-font-sizes [:h4 :xs])
         :font-weight "600"
   ...
   [:pre {:background-color colors/surface
   ...
   ;; Blockquotes
   [:blockquote {:border-left (str "4px solid " colors/primary-light)
   ...
   ;; Lists
   [:ul {:padding-left (responsive/spacing :xl)
         :margin (str (responsive/spacing :md) " 0")}
    [:li {:margin (str (responsive/spacing :xs) " 0")
          :padding (str "0 0 " (responsive/spacing :xs) " 0")}]]

   [:ol {:padding-left (responsive/spacing :xl)
         :margin (str (responsive/spacing :md) " 0")}
    [:li {:margin (str (responsive/spacing :xs) " 0")
          :padding (str "0 0 " (responsive/spacing :xs) " 0")}]]
